...
<html lang="en">
    <head>
        ...
        <title>Admin product deatils</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">User product Details</h2>
...
String sql ="select * from prodetails";
...
<td><%=resultSet.getString("holdername") %></td>
												...
												<td><a class="btn btn-primary"
													...
													href="delete1.jsp?id=<%=resultSet.getString("id") %>">Delete</a></td>
											</tr>
											<%
}
connection.close();
