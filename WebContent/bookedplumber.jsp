                    ...
                    <div class="col-xl-12">
                        <div class="inner-content-box clearfix">
                            <div class="title-s2 text-center">
                                <span>Userpage</span>
                                <h1>Plumber Booking</h1>
                            </div>
                            <div class="breadcrumb-menu float-left">
                                <ul class="clearfix">
                                    <li><a href="index-2.html">Home</a></li>
                                    <li><a href="project.html">Plumber</a></li>
                                    <li class="active">Plumber Book</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
String sql ="SELECT * FROM other_register where category='Plumber'";
                            ...
                            <div class="img-holder">
                                <div class="inner">
                                    ...
                                    <div class="overlay-box">
                                        <div class="box">
                                            <div class="link">
                                                <a href="userbookplum.jsp?id=<%=resultSet.getString("email")%>"><span class="icon-out"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
