...
<html lang="en">
    <head>
        ...
        <title>Electrician deatils</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Booked Electrician Details</h2>
...
String sql ="select * from bookelect";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>

<td><%=resultSet.getString("electname") %></td>
...
<td><%=resultSet.getString("status") %></td>
												...
												<td><a class="btn btn-primary"
													onclick="return confirm('are your sure you want to delete?')"
														href="deleteelect.jsp?id=<%=resultSet.getString("id") %>">Delete</a></td>
											</tr>
											<%
}
connection.close();
