...
<body>
	...
	<div class="preloader"></div>
		...
		%>
		<!--End Main Slider-->
		<form action="bookplum.jsp" method="post">

			<input type="hidden" class="form-control" id="validationDefault01"
				name="plumemail" value="<%=resultSet.getString("email")%>" readonly>
			<input type="hidden" class="form-control" id="validationDefault01"
				name="plumname" value="<%=resultSet.getString("name")%>" readonly>
			<input type="hidden" class="form-control" id="validationDefault01"
