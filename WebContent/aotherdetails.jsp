				...
				<div class="main-page">
					<div class="container-fluid">
						<div class="row page-title-div">
							<div class="col-md-6">
								<h2 class="title">Other Register</h2>
...
String sql ="select * from other_register";
...
%>
											<tr>
												...
												<td><%=resultSet.getString("exp") %></td>
												<td><%=resultSet.getString("address") %></td>
												<td><%=resultSet.getString("status") %></td>
												<td><a class="btn btn-primary"
												onclick="return confirm('Are your sure you want to Accept?')"
												href="accept.jsp?id=<%=resultSet.getString("email") %>,<%=resultSet.getString("name") %>,<%=resultSet.getString("pass") %>">Accept</a></td>
												<td><a class="btn btn-primary"
												onclick="return confirm('Are your sure you want to delete?')"
												href="adminreject.jsp?id=<%=resultSet.getString("email") %>,<%=resultSet.getString("name") %>">Reject</a></td>
											</tr>
											<%
}
connection.close();
