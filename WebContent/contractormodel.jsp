                                            ...
                                            <table id="example"
                                                ...
                                                <%
													try {
														...
														String sql = "select * from bookcont where contemail = '"+ email +"'";
												...
												<tr>
													...
													<td><a class="btn btn-primary"
														href="contacceptmail.jsp?value=<%=resultSet.getString("uemail") %>,<%=resultSet.getString("name") %>,<%=resultSet.getString("contname") %>,<%=resultSet.getString("id") %>">Accept</a></td>
													<td><a class="btn btn-primary"
														href="contrejectmail.jsp?value=<%=resultSet.getString("uemail") %>,<%=resultSet.getString("name") %>,<%=resultSet.getString("contname") %>,<%=resultSet.getString("contemail") %>">Reject</a></td>
												</tr>
												<%
													}
														connection.close();
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="copyright-text text-center">
                            <p><a href="https://www.templateshub.net" target="_blank">Lifestyle Hub</a></p>
                        </div>
                    </div>
                </div>
            </div>
