                    ...
                    <div class="col-xl-12">
                        <div class="inner-content-box clearfix">
                            <div class="title-s2 text-center">
                                <span>Userpage</span>
                                <h1>Electrician Boocking</h1>
                            </div>
                            <div class="breadcrumb-menu float-left">
                                <ul class="clearfix">
                                    <li><a href="index-2.html">Home</a></li>
                                    <li><a href="project.html">Electrion</a></li>
                                    <li class="active">Electrion Book</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
String sql ="SELECT * FROM other_register where category='electrician'";
                            ...
                            <div class="img-holder">
                                <div class="inner">
                                    ...
                                    <div class="overlay-box">
                                        <div class="box">
                                            <div class="link">
                                                <a href="userbookelect.jsp?id=<%=resultSet.getString("email")%>"><span class="icon-out"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
