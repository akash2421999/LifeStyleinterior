...
<head>
<meta charset="UTF-8">
<title>Contractor\process<title>
...
<body>
	...
	<div class="preloader"></div>
		...
		%>
		<!--End Main Slider-->
		<form action="bookcont.jsp" method="post">

			<input type="hidden" class="form-control" id="validationDefault01"
				name="contemail" value="<%=resultSet.getString("email")%>" readonly>
			<input type="hidden" class="form-control" id="validationDefault01"
				name="contname" value="<%=resultSet.getString("name")%>" readonly>
			<input type="hidden" class="form-control" id="validationDefault01"
										...
										<div class="contact-details-form-box">
											...
											<div class="col-xl-12">
													 ...
													 <input type="checkbox" name="design"
														value="design"  required=""><label>Designer</label>
