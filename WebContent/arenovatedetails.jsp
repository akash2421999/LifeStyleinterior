...
<html lang="en">
    <head>
        ...
        <title>Admin renovation deatils</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">User Renovation Details</h2>
...
String sql ="select * from renovation";
...
<td><%=resultSet.getString("price") %></td>
												...
												<td><a class="btn btn-primary"
													...
													href="r1.jsp?id=<%=resultSet.getString("id") %>">Delete</a></td>
											</tr>
											<%
}
connection.close();
