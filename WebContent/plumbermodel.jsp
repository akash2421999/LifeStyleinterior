                                            ...
                                            <table id="example"
                                                ...
                                                <thead>
                                               	...
                                               	<%
													try {
														...
														String sql = "select * from bookplum where plumemail = '"+ email +"'";
												...
												<tr>
													...
													<td><%=resultSet.getString("status")%></td>
														...
														href="plumacceptmail.jsp?value=<%=resultSet.getString("uemail") %>,<%=resultSet.getString("name") %>,<%=resultSet.getString("plumname") %>">Accept</a></td>
														<td><a class="btn btn-primary"
														href="plumrejectmail.jsp?value=<%=resultSet.getString("uemail") %>,<%=resultSet.getString("name") %>,<%=resultSet.getString("plumname") %>,<%=resultSet.getString("plumemail") %>">Reject</a></td>
												</tr>
												<%
													}
														connection.close();
