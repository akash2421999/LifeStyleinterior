									...
									<div class="panel-body p-20">
										...
										<table id="example"
											...
											<tr>
												...
												<td><%=resultSet.getString("packname")%></td>
												<td><%=resultSet.getString("holdername")%></td>
												<td><%=resultSet.getString("cnum")%></td>
												<td><%=resultSet.getString("cc_exp_mo")%></td>
												<td><%=resultSet.getString("cc_exp_yr")%></td>
												<td><%=resultSet.getString("cvv")%></td>
												<td><%=resultSet.getString("amount")%></td>

												<td><%=resultSet.getString("Transactiondate")%></td>

												<td><a class="btn btn-primary"
													onclick="return confirm('are your sure you want to delete?')"
													href="deletepack.jsp?id=<%=resultSet.getString("id")%>">Delete</a></td>
											</tr>
											<%
												}
													connection.close();
