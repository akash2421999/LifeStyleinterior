...
<html lang="en">
    <head>
        ...
        <title>Book Contractor deatils</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Booked Contractor Details</h2>
...
String sql ="select * from bookcont";
...
<td><%=resultSet.getString("status") %></td>
													...
													href="deletecont.jsp?id=<%=resultSet.getString("id") %>">Delete</a></td>
											</tr>
											<%
}
connection.close();
