...
<body>
  ...
  <section class="top-bar-style1">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="top-style1 clearfix">
                            <p>Welcome To Lifestyle Interior India</a></p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <nav class="main-menu clearfix">
                                        ...
                                        <div class="navbar-collapse collapse clearfix">
                                            <ul class="navigation clearfix">
                                                <li class="dropdown current"><a href="index.jsp">Home</a>
                                                    <ul>
                                                ...
                                                <li class="dropdown"><a href="">Register</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="contractor.jsp">Contractor</a></li>
                                                        <li><a href="plumber.jsp">Plumber</a></li>
                                                        <li><a href="electrion.jsp">Electrician</a></li>
                                                        <li><a href="painter.jsp">Painter</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown"><a href="#ser">Services</a>
                                                   
                                                </li>
                                                <li class="dropdown"><a href="#pro">Projects</a>
                                    ...
                                    <li>
                                        <div class="single-item">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>South End circle, Janinagar</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
        ...
        <section class="highlights-area" id="ser">
            <div class="container">
                <div class="row">
        ...
        <!--Start about area-->
        <section class="about-area" id="pro">
            <div class="container">
                <div class="row">
        ...
        <section class="working-process-area" id="con">
            <div class="container">
