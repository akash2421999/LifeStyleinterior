...
<title>Admin painter deatils</title>
				...
				<div class="main-page">
					<div class="container-fluid">
						<div class="row page-title-div">
							<div class="col-md-6">
								<h2 class="title">Painter Details</h2>
									...
									<div class="panel-body p-20">
										...
										<table id="example"
											...
											<tr>
												...
												<td><%=resultSet.getString("painting")%></td>
												...
												<td><a class="btn btn-primary"
													href="adminpainterassign.jsp?id=<%=resultSet.getString("id")%>">Assign</a></td>
												<td><a class="btn btn-primary"
													onclick="return confirm('are your sure you want to delete?')"
													href="delete.jsp?id=<%=resultSet.getString("id")%>">Delete</a></td>
											</tr>
											<%
												}
													connection.close();
