...
<html lang="en">
    <head>
        ...
        <title>Book Plumber Admiin</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Booked Plumber Details</h2>
...
String sql ="select * from bookplum";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>

<td><%=resultSet.getString("plumemail") %></td>
...
<td><%=resultSet.getString("status") %></td>
												...
												<td><a class="btn btn-primary"
													...
													href="deleteplum.jsp?id=<%=resultSet.getString("id") %>">Delete</a></td>
											</tr>
											<%
}
connection.close();
