		...
		<header class="main-header header-style2 stricky">
			<div class="inner-container clearfix">
				<div class="logo-box-style2 float-left">
					<a href="index.jsp"> <img src="images/resources/logo.png"
						alt="Awesome Logo">
					</a>
				</div>
						...
						<div class="inner-content-box clearfix">
							...
							<div class="breadcrumb-menu float-left">
								<ul class="clearfix">
									...
									<li class="active">contractor login</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
						<div class="form">
							<div class="shop-page-title">
							 ...
							 <div class="row">
        <form action="OtherLoginServlet" method="post">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="input-field">
                                            ...
                                            <div class="icon-holder">
                                                ...
                                                <input class="form-control" type="hidden" name="category" value="contractor" required="required">
						...
						<div class="form register">
							...
							<div class="row">
								<form class="custom-form" action="OtherRegisterServlet"
									...
									<div class="col-md-12">
										<div class="input-field">
											<input type="hidden" name="category" value="contractor">
											<div class="icon-holder">
												<i class="fa fa-user" aria-hidden="true"></i>
											</div>
										</div>
									...
									<div class="col-md-12">
										<div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-12">
												<div class="right">
													<h6>
														<span>*</span>You must be a free registered user to submit
														content.
													</h6>
												</div>
											</div>
