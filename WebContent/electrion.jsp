...
<body>
    <div class="boxed_wrapper">
        ...
        <form action="OtherLoginServlet" method="post">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="input-field">
                                            <input type="hidden" name="category" value="electrion">
                                            <div class="icon-holder">
                                                <i class="fa fa-unlock-alt" aria-hidden="true"></i>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        <div class="form register">
                            ...
                            <div class="row">
			<form class="custom-form" action="OtherRegisterServlet" method="post">
                                    <div class="col-md-12">
                                        <div class="input-field">
